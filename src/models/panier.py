...
class Panier:
    ...
    def __init__(self,
        ...
        Args:
            ...
            liste_produits_quantite (list[Produit], quantite): liste des produits et leur quantité dans le panier
        """
        self.date_panier = date_panier
        self.prix_total = prix_total
        self.liste_produits_quantite = liste_produits_quantite if liste_produits_quantite else []
